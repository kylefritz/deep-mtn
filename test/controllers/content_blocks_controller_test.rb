...
class ContentBlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content_block" do
    assert_difference('ContentBlock.count') do
      post content_blocks_url, params: { content_block: { name: @content_block.name, page: @content_block.page } }
    end
  ...
  test "should update content_block" do
    patch content_block_url(@content_block), params: { content_block: { name: @content_block.name, page: @content_block.page } }
